...
import com.yudikryn.productapps.databinding.ItemFavoriteBinding
import com.yudikryn.productapps.helper.FormatHelper.formatDollar

class FavoriteAdapter(private val onClick: (product: Product, action: String, position: Int) -> Unit) : ListAdapter<Product, FavoriteAdapter.MyViewHolder>(DIFF_CALLBACK) {
    ...
    class MyViewHolder(private val binding: ItemFavoriteBinding) : RecyclerView.ViewHolder(
        binding.root
    ) {
